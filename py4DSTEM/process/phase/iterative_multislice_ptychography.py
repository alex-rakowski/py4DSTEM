...
class MultislicePtychographicReconstruction(PtychographicReconstruction):
    ...
    def __init__(
        ...
        energy: float,
        num_slices: int,
        slice_thicknesses: float | Sequence[float],
        ...
        initial_scan_positions: np.ndarray | None = None,
        theta_x: float = 0,
        theta_y: float = 0,
    ...
    def preprocess(
        ...
        force_com_transpose: float | None = None,
        force_com_shifts: float | None = None,
    ...
    def reconstruct(
        ...
        kz_regularization_gamma: float | np.ndarray | None = None,
