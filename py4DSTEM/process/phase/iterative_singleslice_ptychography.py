...
class SingleslicePtychographicReconstruction(PtychographicReconstruction):
    ...
    def __init__(
        ...
        initial_scan_positions: Optional[np.ndarray] = None,
    ...
    def preprocess(
        ...
        force_com_transpose: Optional[float] = None,
        force_com_shifts: Optional[float] = None,
    ...
    def reconstruct(
        ...
        tv_denoise_weight: Optional[float] = None,
