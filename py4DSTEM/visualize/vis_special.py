...
def show_strain(
    ...
    # Get images
    e_xx = np.ma.array(
        strainmap.get_slice("e_xx").data, mask=strainmap.get_slice("mask").data is False
    )
    e_yy = np.ma.array(
        strainmap.get_slice("e_yy").data, mask=strainmap.get_slice("mask").data is False
    )
    e_xy = np.ma.array(
        strainmap.get_slice("e_xy").data, mask=strainmap.get_slice("mask").data is False
    )
    theta = np.ma.array(
        strainmap.get_slice("theta").data,
        mask=strainmap.get_slice("mask").data is False,
    )
